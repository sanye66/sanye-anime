  ...
  <div class="page-stack narrow-page">
    ...
    <section class="profile-panel">
      ...
      <div>
        ...
        <p>管理你的收藏、历史记录和 AI 对话，让每一次相遇都被好好记录。</p>
      </div>
      <button v-if="!auth.loggedIn" class="primary-button" type="button" @click="auth.loginRedirect()">登录</button>
    </section>
    ...
    <div class="settings-list personal-settings-list">
